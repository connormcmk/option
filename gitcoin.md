...
Option is a prediction market for governance. [Prediction markets](https://en.wikipedia.org/wiki/Prediction_market) have long been considered an effective way [for groups to make more accurate collective inferences](https://www.science.org/doi/10.1126/science.1157679). The basic way they work is simple: Anyone can create a market. Like, “It will rain on Thursday.” Then other people can bet on the outcome. If the market maker says it rained then the people that bet YES get paid, otherwise the people that bet NO get paid. 
